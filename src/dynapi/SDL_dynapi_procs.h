...
SDL_DYNAPI_PROC(int,SDL_WriteProcess,(SDL_Process a, const void *b, int c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_ReadProcess,(SDL_Process a, void *b, int c),(a,b,c),return)
SDL_DYNAPI_PROC(int,SDL_ReadErrProcess,(SDL_Process a, void *b, int c),(a,b,c),return)
